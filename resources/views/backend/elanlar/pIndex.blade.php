                        ...
                        <table id="data-table-advance" class="table table-lg table-hover">
                            ...
                            @foreach($elanlar as $elan)
                                <tr>
                                    ...
                                    <td>{{ $elan->name }}</td>
                                    <td>
                                        <a href="{{ url('admin/elanactive/'.$elan->id) }}" class="settings" title="Aktiv Et" data-toggle="tooltip" data-original-title="Aktiv Et"><i class="ti-check"></i></a>
                                        <a href="{{ url('admin/elansil/'.$elan->id) }}" class="delete" title="Sil" data-toggle="tooltip" data-original-title="Sil"><i class="ti-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
